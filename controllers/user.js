...
const loadUser = async (req, res, next) => {
  ...
  try {
    ...
    if (user) {
      ...
      res.cookie("token", token, { httpOnly: true, secure: true, sameSite: "None", domain: "swip-tory-frontend-harsh7231.vercel.app"});
    } else {
...
const register = async (req, res, next) => {
  try {
    ...
    res.cookie("token", token, { httpOnly: true, strict: true, secure: true, sameSite: "None", domain: "swip-tory-frontend-harsh7231.vercel.app" });
